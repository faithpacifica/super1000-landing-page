    ...
    <div class="footer-bottom flex-center justify-between">
      ...
      <div class="footer-socials flex items-center">
        <div class="hero-socials_wrapper flex gap-[9rem] mr-[8rem]">
          <!-- INSTA -->
          <a class="bg-[#808191] rounded-[50%] px-[5px] pb-[4px] pt-[6px] hover:bg-[#C013CA] transition duration-500 ease" href="https://www.instagram.com/" target="_blank">
          ...
          <!-- youtube -->
          <a class="bg-[#808191] rounded-[50%] px-[5px] pt-[7px] pb-[6.5] hover:bg-[#FF0000] transition duration-500 ease" href="https://www.youtube.com/" target="_blank">
          ...
          <!-- telegram -->
          <a class="bg-[#808191] rounded-[50%] px-[5px] py-[6px] hover:bg-[#279FDA] transition duration-500 ease" href="https://www.telegram.org/" target="_blank">
