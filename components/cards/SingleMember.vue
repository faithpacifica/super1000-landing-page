<template>
<div
:class="name == 'Aziz Halikov' ? 'single-member relative bg-white dark:bg-[#2B2F3A] overflow-hidden rounded-[16rem]   w-[224px] h-[200px]': 'single-member relative bg-white dark:bg-[#2B2F3A] overflow-hidden rounded-[16rem]  w-[224px] h-[200px]' "
>

    <img v-if="name == 'Aziz Halikov'" class="z-5 absolute bottom-0 left-0 right-[10rem]" src="@/assets/images/aziz-shadow.png" >
    <img v-else class="z-5 absolute bottom-0 left-0 right-0" src="@/assets/images/member-shadow.png">
...
.single-member {
  ...
  &:hover .card-info{
    background: rgba(109, 53, 225, 0.7);
